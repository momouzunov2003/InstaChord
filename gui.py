...
top_frame = customtkinter.CTkFrame(root,fg_color="#383b39",height=40,corner_radius=0)
...
search_textbox.pack(expand=False,pady=5,padx=10,ipadx=50,side="left")
...
upload_button.pack(side="right",padx=10,pady=5,ipadx=10)

bottom_frame = customtkinter.CTkFrame(root,fg_color="#383b39",height=30,corner_radius=0)
bottom_frame.pack(side="bottom", fill="x")

credits = customtkinter.CTkLabel(bottom_frame,text="For the people, by the people...",text_color="#595e5b")
credits.pack()

central_frame = customtkinter.CTkFrame(root,fg_color="#383b39")
central_frame.pack(fill="both",expand=True,pady=3,padx=3)